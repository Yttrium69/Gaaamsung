    ...
    return (
        <div className="sect_right">
            ...
            <div className='menus_container'>
                ...
                <div className='title_menu_pack base'>
                    ...
                    <div className='item_container'>
                        <Menu label={0} title={'Citrus'} tag={["유쾌한", "귀여운"]} img_path={"img/note/citrus.png"}/>
                        <Menu label={0} title={'Citrus'} tag={["유쾌한", "귀여운"]} img_path={"img/note/citrus.png"}/>
                        <Menu label={0} title={'Citrus'} tag={["유쾌한", "귀여운"]} img_path={"img/note/citrus.png"}/>
                        <Menu label={0} title={'Citrus'} tag={["유쾌한", "귀여운"]} img_path={"img/note/citrus.png"}/>
                    </div>
                </div>
                <div className='title_menu_pack middle'>
                    <div className='text_icon_pack'>
                        <p className='text'>Middle Note</p>
                        <div className='icon_container'>
                            <img src='/img/icon/icon_help.svg' alt='help icon'></img>
                        </div>
                    </div>
                ...
                <div className='title_menu_pack top'>
                    <div className='text_icon_pack'>
                        <p className='text'>Top Note</p>
                        <div className='icon_container'>
                            <img src='/img/icon/icon_help.svg' alt='help icon'></img>
                        </div>
                    </div>
